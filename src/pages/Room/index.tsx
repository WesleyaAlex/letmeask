...
import { push, ref, database, remove } from '../../services/firebase'
import './room.scss'
        ...
        <div id='page-room'>
            ...
            <main className='content'>
                ...
                <form onSubmit={handleSendQuestion}>
                    <textarea placeholder='O que você quer perguntar?' value={newQuestion} onChange={(e) => setNewQuestion(e.target.value)}></textarea>
